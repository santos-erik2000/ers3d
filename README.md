...
CRM operacional da ERS 3D Soluções e Fabricações. Este README cobre a **Fundação** (Sprint 0 + Sprint 1 do backlog) — setup do projeto, banco, autenticação e permissões por ação —, o módulo **Clientes** (Sprint 2), o **Kanban CRM** (Sprint 3), **Filamentos & Calculadora** (Sprint 4), **Orçamento & Ciclo mensal** (Sprint 5), **Produção** (Sprint 6), **Qualidade** (Sprint 7) e **Estoque de peças & Entrega** (Sprint 8). O módulo de negócio restante (Financeiro) entra no sprint seguinte, conforme a Etapa 5 do planejamento.
...
src/
  ...
  modules/              camada de domínio — uma pasta por módulo de negócio
    ...
    finance/ reports/ catalogs/ files/ notifications/ settings/
...
- **Pendências financeiras justificadas** (parte da pré-condição de Entrega → Concluído da seção 09) continua como `TODO` — depende do módulo `finance`, Sprint 9
