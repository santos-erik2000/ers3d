...
CRM operacional da ERS 3D Soluções e Fabricações. Este README cobre a **Fundação** (Sprint 0 + Sprint 1 do backlog) — setup do projeto, banco, autenticação e permissões por ação —, o módulo **Clientes** (Sprint 2), o **Kanban CRM** (Sprint 3), **Filamentos & Calculadora** (Sprint 4), **Orçamento & Ciclo mensal** (Sprint 5), **Produção** (Sprint 6) e **Qualidade** (Sprint 7). Os demais módulos de negócio (Entrega, Financeiro) entram nos sprints seguintes, conforme a Etapa 5 do planejamento.
