 ...
 * `acceptedAt` da própria versão sendo aprovada. Não move o card do Kanban,
 * não mexe em estoque/financeiro (isso é Sprint 6/9) — é só o registro do
 * orçamento aprovado. Versões já decididas (aprovadas ou rejeitadas) não
 * podem ser reaprovadas: a correção é sempre uma nova versão.
 */
